...
var extraJumpsPerGroundTouch : int = 0
export var extraJumpPower : float = 180
export var iniitalExtraJumpBoosMultiplier = 1
...
func CheckOnGround():
	var g = (floorCastLeft.is_colliding() || floorCastRight.is_colliding() )
	
	if g :
		 extraJumps = extraJumpsPerGroundTouch
	return g
